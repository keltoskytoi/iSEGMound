...
paths<-link2GI::initProj(projRootDir = projRootDir,
                         projFolders = c("analysis/data/literature_analysis/",
                                         ...
                                         "analysis/results/7a_iSEG_AOI_1/",
                                         "analysis/results/7b_iSEG_AOI_2/",
                                         "analysis/results/7c_iSEG_AOI_3/",
                                         "analysis/results/7d_iSEG_AOI_4/",
                                         "analysis/results/7e_iSEG_AOI_5/",
                                         "analysis/qgis/",
