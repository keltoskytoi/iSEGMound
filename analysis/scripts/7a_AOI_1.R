...
#read shapefile for posssiblemounds for AoI 1:
...
segments_iSEG_mtpi_WS_AOI_1 <- readOGR(paste0(path_analysis_results_7a_iSEG05_AOI_1,
                                           "segments_shape_descriptive_joined_mtpi_WS_AOI_1.shp"))
names(segments_iSEG_mtpi_WS_AOI_1)
...
segments_iSEG_mtpi_WS_AOI_1_filt <- segments_iSEG_mtpi_WS_AOI_1[segments_iSEG_mtpi_WS_AOI_1$A <= 576.1 & segments_iSEG_mtpi_WS_AOI_1$A >= 45.20 &
                                                                segments_iSEG_mtpi_WS_AOI_1$Sphrcty >= 0.2951891 & segments_iSEG_mtpi_WS_AOI_1$Sphrcty <= 0.6417927 &
                                                                segments_iSEG_mtpi_WS_AOI_1$Shp_Ind >= 1.558135 & segments_iSEG_mtpi_WS_AOI_1$Shp_Ind <= 3.387660 &
                                                                segments_iSEG_mtpi_WS_AOI_1$elongtn >= 1.122960 & segments_iSEG_mtpi_WS_AOI_1$elongtn <=1.913620 &
                                                                segments_iSEG_mtpi_WS_AOI_1$cmpctns >= 0.09396160 & segments_iSEG_mtpi_WS_AOI_1$cmpctns <= 0.2042890 &
                                                                segments_iSEG_mtpi_WS_AOI_1$rondnss >= 5.00866 & segments_iSEG_mtpi_WS_AOI_1$rondnss <= 22.2684,]
mapview::mapview(segments_iSEG_mtpi_WS_AOI_1_filt) + burial_mounds_32632
#------------------------------------------------------------------------------#
rgdal::writeOGR(obj=segments_iSEG_mtpi_WS_AOI_1_filt, dsn = "C:/Users/kelto/Documents/iSEGMound/analysis/results/7a_iSEG05_AOI_1",
                layer ="iSEG_AOI_1", driver = "ESRI Shapefile", verbose = TRUE, overwrite_layer = TRUE)
