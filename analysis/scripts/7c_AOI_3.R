################################################################################
#########################THE WORKFLOW APPLIED ON THE AoI 3######################
################################################################################
####--------------------------------SHORTCUTS-------------------------------####
lsAOI3<-  list.files(file.path(path_analysis_results_AOI_3),
                     full.names = TRUE, pattern = glob2rx("*.tif"))

lsAOI3
#[1] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32484_5625_1_he_xyzirnc_ground_05.tif"
#[2] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32485_5623_1_he_xyzirnc_ground_05.tif"
#[3] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32485_5624_1_he_xyzirnc_ground_05.tif"
#[4] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32485_5625_1_he_xyzirnc_ground_05.tif"
#[5] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32485_5626_1_he_xyzirnc_ground_05.tif"
#[6] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32486_5623_1_he_xyzirnc_ground_05.tif"
#[7] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32486_5624_1_he_xyzirnc_ground_05.tif"
#[8] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32486_5625_1_he_xyzirnc_ground_05.tif"
#[9] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32486_5626_1_he_xyzirnc_ground_05.tif"
#[10] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32486_5627_1_he_xyzirnc_ground_05.tif"
#[11] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32487_5626_1_he_xyzirnc_ground_05.tif"
#[12] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32487_5627_1_he_xyzirnc_ground_05.tif"
#[13] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//3dm_32487_5628_1_he_xyzirnc_ground_05.tif"
#[14] "/home/keltoskytoi/repRCHrs/analysis/results/AOI_3//AOI_3_xyzirnc_ground_05.tif"

################################################################################
####-----------------------------#1. READ DTM#------------------------------####
AOI_3 <- raster(lsAOI3[[14]])
crs(AOI_3)
...
generate_mtpi_SAGA(dtm=AOI_3,
                   output= paste0(path_analysis_results_7c_iSEG_AOI_3),
                   tmp= paste0(path_tmp),
                   scale_min=1,
                   scale_max=30,
                   scale_num=20,
                   crs=crs(AOI_3))
#read mtpi
TAdDTM05 <- raster::raster(paste0(path_analysis_results_7c_iSEG_AOI_3, "dDTM05.tif"))
################################################################################
####--------------------------#3. FILTER DERIVATIVE#------------------------####
...
#export filter
raster::writeRaster(TAfdDTM05, paste0(path_analysis_results_7c_iSEG_AOI_3, "/TAfdDTM05.tif"),
                    format= "GTiff", overwrite = TRUE, NAflag = 0)

#because we are writing continuously in the folder let's use the exact path
TAfdDTM05 <- raster::raster(paste0(path_analysis_results_7c_iSEG_AOI_3, "TAfdDTM05.tif"))
################################################################################
...
raster::writeRaster(TAifdDTM05, paste0(path_analysis_results_7c_iSEG_AOI_3,
                    "/TAifdDTM05.tif"), format= "GTiff", overwrite = TRUE, NAflag = 0)

#read inverse filtered DTM05
TAifdDTM05 <- raster::raster(paste0(path_analysis_results_7c_iSEG_AOI_3, "/TAifdDTM05.tif"))
################################################################################
...
TApf_ifdDTM_WL05 <- raster::raster(paste0(path_analysis_results_7c_iSEG_AOI_3, "pf_ifDTM_W&L.tif"))
################################################################################
...
raster::writeRaster(TAdiff_ifdDTM05, paste0(path_analysis_results_7c_iSEG_AOI_3,
...
writeRaster(TAfiltered_diff_ifdDTM05, paste0(path_analysis_results_7c_iSEG_AOI_3,
...
TAfdiff_ifdDTM05_modal3 <- raster::raster(paste0(path_analysis_results_7c_iSEG_AOI_3,
...
segments_iSEG_mtpi_WS_AOI_3@data$compactness <- (sqrt(4*segments_iSEG_mtpi_WS_AOI_3@data$A/pi))/segments_iSEG_mtpi_WS_AOI_3@data$P
segments_iSEG_mtpi_WS_AOI_3@data$roundness <- (4*segments_iSEG_mtpi_WS_AOI_3@data$A)/(pi*segments_iSEG_mtpi_WS_AOI_3@data$Fmax)
segments_iSEG_mtpi_WS_AOI_3@data$elongation <- segments_iSEG_mtpi_WS_AOI_3@data$Fmax/segments_iSEG_mtpi_WS_AOI_3@data$Fmin

names(segments_iSEG_mtpi_WS_AOI_3)
...
rgdal::writeOGR(obj=segments_iSEG_mtpi_WS_AOI_3, dsn = "/home/keltoskytoi/repRCHrs/analysis/results/7c_iSEG_AOI_3",
                layer ="segments_shape_descriptive_joined_mtpi_WS_AOI_3", driver = "ESRI Shapefile",
                verbose = TRUE, overwrite_layer = TRUE)
################################################################################
#in case that you want to read the segments at a later point, you will have to
#change the column names:
segments_iSEG_mtpi_WS_AOI_3 <- readOGR(paste0(path_analysis_results_7c_iSEG05_AOI_3,
                                           "segments_shape_descriptive_joined_mtpi_WS_AOI_3.shp"))
names(segments_iSEG_mtpi_WS_AOI_3)
...
segments_iSEG_mtpi_WS_AOI_3_filt <- segments_iSEG_mtpi_WS_AOI_3[segments_iSEG_mtpi_WS_AOI_3$A <= 576.1 & segments_iSEG_mtpi_WS_AOI_3$A >= 45.20 &
                                                                segments_iSEG_mtpi_WS_AOI_3$Sphrcty >= 0.2951891 & segments_iSEG_mtpi_WS_AOI_3$Sphrcty <= 0.6417927 &
                                                                segments_iSEG_mtpi_WS_AOI_3$Shp_Ind >= 1.558135 & segments_iSEG_mtpi_WS_AOI_3$Shp_Ind <= 3.387660 &
                                                                segments_iSEG_mtpi_WS_AOI_3$elongtn >= 1.122960 & segments_iSEG_mtpi_WS_AOI_3$elongtn <=1.913620 &
                                                                segments_iSEG_mtpi_WS_AOI_3$cmpctns >= 0.09396160 & segments_iSEG_mtpi_WS_AOI_3$cmpctns <= 0.2042890 &
                                                                segments_iSEG_mtpi_WS_AOI_3$rondnss >= 5.00866 & segments_iSEG_mtpi_WS_AOI_3$rondnss <= 22.2684,]
mapview::mapview(segments_iSEG_mtpi_WS_AOI_3_filt) + burial_mounds_32632
#------------------------------------------------------------------------------#
rgdal::writeOGR(obj=segments_iSEG_mtpi_WS_AOI_3_filt, dsn = "C:/Users/kelto/Documents/iSEGMound/analysis/results/7c_iSEG05_AOI_3",
                layer ="iSEG_AOI_3", driver = "ESRI Shapefile", verbose = TRUE, overwrite_layer = TRUE)
