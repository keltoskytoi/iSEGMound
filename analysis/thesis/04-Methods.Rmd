...
```{r Figure26, echo=FALSE, fig.show='hold', fig.align = "default", out.width="50%", out.height="50%", fig.cap="Left: Hillshade of Site ID 5. Right: Hillshade of Site ID 5 overlayed by transparent mound polygons. Scale 1:1500"}
...
```{r Figure27, echo=FALSE, fig.align='center', out.width="40%", out.height="40%", fig.cap="Documentation of burial mound group Site ID 5-9 in the field."}
