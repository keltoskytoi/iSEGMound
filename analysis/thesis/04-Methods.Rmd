...
The  steps undertaken and tested  are depicted and summarized in Figure 29. The code for this subchapter can be found in script **2_LiDAR_data_processing_tile_1.R**.
...
```{r code-block-1, echo=TRUE, results='asis'}
lsLIDAR_2009_10 <- list.files(here::here("C:/Users/kelto/Documents/reRCHrs_REPO/LiDAR_2009_10"),
